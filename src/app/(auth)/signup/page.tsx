        ...
        <Wrapper>
            <div className='bg-white p-[60px] flex flex-col gap-6 border border-black shadow-md rounded-xl'>
                ...
                <form className='flex flex-col gap-6' onSubmit={FormSubmitHandler}>
                    <input type="text" id="fullname" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#999999] focus:border-[#999999] focus:outline-none block w-full p-2.5 " placeholder="Your name" name='fullname' value={credential.fullname} onChange={HandleOnChangeCredential} />
