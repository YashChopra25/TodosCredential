...
import { arrayType } from "@/lib/features/app-slice";
const HomePage = () => {
            ...
            <div className="px-4 py-6 bg-[#DEDEDE] w-full flex flex-col gap-4">
                ...
                <div className="w-full h-full bg-white rounded-md grid grid-cols-4 p-4 gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {
                            todos?.map((todo: arrayType) => (
                                <TodoCard key={todo.id} createdAt={todo.createdAt} date={todo.date} id={todo.id} description={todo.description} priority={todo.priority} title={todo.title} />
                            ))
                        }
                        <div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {
                            in_progress?.map((todo: arrayType) => (
                                <TodoCard key={todo.id} createdAt={todo.createdAt} date={todo.date} id={todo.id} description={todo.description} priority={todo.priority} title={todo.title} />
                            ))
                        }
                        <div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {
                            under_review?.map((todo: arrayType) => (
                                <TodoCard key={todo.id} createdAt={todo.createdAt} date={todo.date} id={todo.id} description={todo.description} priority={todo.priority} title={todo.title} />
                            ))
                        }
                        <div>
